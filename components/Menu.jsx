...
const menu = [
  {
    img: "/menu/item-1.png",
    title: "Stilton & pancetta penne",
    price: "$24.00",
  },
  {
    img: "/menu/item-2.png",
    title: "Chorizo and ovacdo spaghetti",
    price: "$24.00",
  },
  {
    img: "/menu/item-3.png",
    title: "Crayfirst and block pepper toastie",
    price: "$26.00",
  },
  {
    img: "/menu/item-4.png",
    ...
    <section className="relative py-12 xl:py-24 bg-menu" id="menu">
      <div className="container mx-auto">
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: false, amount: 0.2 }}
          className="grid gap-[30px] grid-cols-1 md:grid-cols-3 md:gap-[15px] xl:grid-cols-4"
        >
          {menu.map((item, index) => {
            return (
              <div
